...
public class WizardControllerIntegrationTest {
    ...
    void testFindWizardByIdNotFound() throws Exception {
        this.mockMvc.perform(get(this.baseUrl + "/wizards/9").accept(MediaType.APPLICATION_JSON).header(HttpHeaders.AUTHORIZATION, this.token))
    ...
    void testAddWizardErrorWithInvalidInput() throws Exception {
        Wizard wizard = new Wizard();
        wizard.setName(""); // Name is not provided.
    ...
    void testUpdateWizardSuccess() throws Exception {
        Wizard wizard = new Wizard();
        wizard.setName("Harry Potter-update");
